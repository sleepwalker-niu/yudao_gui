...
class MethodSelectionDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("信息统计方法选择")
        self.setFixedSize(300,200)
        layout = QtWidgets.QVBoxLayout()

        self.double_detection_button = QtWidgets.QRadioButton("双检测线方法")
        layout.addWidget(self.double_detection_button)

        self.id_based_button = QtWidgets.QRadioButton("基于ID的方法")
        layout.addWidget(self.id_based_button)
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.create_button("信息统计方法选择", self.show_method_selection_dialog)
